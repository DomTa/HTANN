# Architecture PowerApps
## Objet :
Cette application sert à convertir les fichier DataSource.json en fichier lisible.
Les formats d'exports sont :
1. Mermaid (pour diagramme ER)
2. JSON structuré (complet)
3. CSV des tables et colonnes
4. XML Draw.io
5. HTML (complet avec références)
6. Tous les formats
